...
OpenSea is the exception to this. OpenSea will collect royalties on the secondary sales directly. These royalties are then transferred to Art Blocks and Art Blocks will then manually transfer those royalties to each artist. Royalty distributions will be announced in our artist channel.
